...
public class Management {
    ...
    public void addUser(String userType, String name, String surname, String email, String password, String profession,
        ...
        User user = new User(name,profession, surname,email,password,age);
    ...
    public void addHomeAddress(User user, String streetAddress, String city, String state, String zipCode) {
        Adress homeAddress = new HomeAddress(streetAddress, city, state, zipCode);
        AddressManager.addAdress(user, homeAddress);
    ...
    public void addBusinessAddress(User user, String companyName, String streetAddress, String city, String state,
                                   String zipCode) {
        Adress businessAddress = new BusinessAddress(streetAddress, city, zipCode, state, companyName);
        AddressManager.addAdress(user, businessAddress);
    ...
    public void listAccounts() {
        TreeSet<Account> accountList = accountManager.getAccountTreeSet();
        ...
        for (Account a : accountList) {
            System.out.format(format, a.getUser().getIsim(), a.getUser().getSoyIsim(), a.getUser().getEmail(),
                    a.getUser().getSifre(), a.getUser().getMeslek(), a.getUser().getYas(),
                    a.getUser().getSonGirisTarihi(), a.getClass().getSimpleName());
        }
    }

    public boolean isHaveAccount() {
        return accountManager.getAccountTreeSet().isEmpty();
    }
